...
.topbar {
        ...
        .brand i { font-size: 1.5rem; color: var(--primary-green); }
        .brand .headtext { color: var(--primary-hover); font-size: 1.4rem; font-family: 'Oswald', sans-serif; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; }

        .topbar nav { display: flex; gap: 10px; }
        .topbar a {
            display: flex; align-items: center; gap: 8px; padding: 8px 16px;
            border: none; background: transparent; border-radius: 6px;
            color: var(--text-light); font-family: 'Poppins', sans-serif; font-weight: 500;
            cursor: pointer; transition: all 0.3s ease;
        }
        .topbar a:hover { background-color: rgba(46, 125, 50, 0.08); color: var(--primary-green); }
           .dashboard-grid {
            display: grid;
        ...
        .form-group label { display: block; margin-bottom: 0.4rem; font-size: 0.85rem; font-weight: 600; color: var(--text-light); }
        .form-group textarea,input[type="text"],input[type="email"],input[type="password"]   {
            width: 100%; padding: 10px 14px;
            border: 1px solid var(--border-color); border-radius: 6px;
            font-family: 'Poppins', sans-serif; font-size: 0.9rem;
            background-color: #fafafa; transition: all 0.3s;
        }
        .form-group textarea,input[type="text"],input[type="email"],input[type="password"]:focus {
            outline: none; border-color: var(--primary-green);
            background-color: #fff; box-shadow: 0 0 0 3px rgba(46, 125, 50, 0.1);
        }
        ...
        .btn-sm {
            padding: 6px 12px; font-size: 0.8rem; border-radius: 4px;
        }
        .form-select:focus {
